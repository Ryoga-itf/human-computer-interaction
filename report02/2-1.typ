...
#footnote[https://www.yorku.ca/mack/ijhcs2004.pdf の結果による。今回の実験内容と環境が似ているため、考察に有用ではないかと考え使用した。] <fn1>
